...
function Edit(props) {
  var _useState = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["useState"])([{
    ...
    isActive: false
      ...
      accordionItem = _useState2[0],
      setaccordionItem = _useState2[1];

  var openOne = true;

  var classToggleItem = function classToggleItem(id) {
    var newAccordionList = accordionItem.map(function (accordion) {
      if (!openOne && accordion.id === id) {
        return _objectSpread(_objectSpread({}, accordion), {}, {
  ...
  }, accordionItem.map(function (acoordionValue, idx) {
    var id = acoordionValue.id,
        title = acoordionValue.title,
        description = acoordionValue.description,
        isActive = acoordionValue.isActive;
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
      className: "cwp_accordion_item_wrapper",
      key: idx
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
      classNmae: "cwp_wrapper_inner"
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("a", {
      className: "acfb_accordion_content",
      onClick: function onClick() {
        return classToggleItem(id);
      }
    }, title), isActive && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
      className: "acfb_accordion_content"
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("p", null, description))));
  })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__["InspectorControls"], null));
}
...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__["registerBlockType"])('create-block/accordion', {
   ...
   */
  description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Example block written with ESNext standard and JSX support – build step required.', 'accordion'),
...
function save() {
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Accordion – hello from the saved content!', 'accordion'));
}
